...
(function() {
  var Encoder, Message, Parser, bufeq_fast, clearsign, crc_table, createcrc24, decode, encode, formatCheckSum, getCheckSum, katch, make_line, strip, uint_to_buffer, verifyCheckSum, _ref;

  _ref = require('./util'), strip = _ref.strip, katch = _ref.katch, bufeq_fast = _ref.bufeq_fast, uint_to_buffer = _ref.uint_to_buffer;
  ...
  exports.Parser = Parser = (function() {
    ...
    Parser.prototype.find_checksum = function() {
      ...
      if (((l = this.last_line()) != null) && l[0] === '=') {
        return this.checksum = strip(this.payload.pop().slice(1));
      }
    };
